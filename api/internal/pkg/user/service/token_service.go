...
type TokenService interface {
	...
	GenerateAuthTokens(c *fiber.Ctx, user *model.User) (*response.Tokens, error)
	GenerateResetPasswordToken(c *fiber.Ctx, req *request.ForgotPassword) (string, error)
...
func (s *tokenService) GenerateAuthTokens(c *fiber.Ctx, user *model.User) (*response.Tokens, error) {
	...
	return &response.Tokens{
		Access: response.TokenExpires{
			Token:   accessToken,
			Expires: accessTokenExpires,
		},
		Refresh: response.TokenExpires{
			Token:   refreshToken,
...
func (s *tokenService) GenerateResetPasswordToken(c *fiber.Ctx, req *request.ForgotPassword) (string, error) {
