...
func NewAuthController(
	...
	tokenService service.TokenService, emailService shared.EmailService,
) *AuthController {
...
// @Accept       json
// @Produce      json
// @Param        request  body  request.Register  true  "Request body"
...
func (a *AuthController) Register(c *fiber.Ctx) error {
	...
	return c.Status(fiber.StatusCreated).JSON(utils.ToSuccessResponse(tokens))
}
...
func (a *AuthController) Login(c *fiber.Ctx) error {
	...
	return c.Status(fiber.StatusOK).JSON(utils.ToSuccessResponse(tokens))
}
...
func (a *AuthController) Logout(c *fiber.Ctx) error {
	...
	return c.Status(fiber.StatusOK).JSON(utils.ToSuccessResponse(nil))
}
...
func (a *AuthController) GoogleCallback(c *fiber.Ctx) error {
	...
	googleUser := new(request.GoogleLogin)
